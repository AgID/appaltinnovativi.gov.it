...
//e la stringa "Nome Sito Child" altrettanto,ma nella maniera in cui viene visualizzato nel campo "Programma"
// definito su Strapi
export const InEvidenzaQuery = graphql`
query allNomeSitoChildSfide {
  allStrapiSfida(filter: {programma: {nome: {eq: "Nome Sito Child"}}}) {
    nodes {
      id
      stato
      bollinoOPEN
